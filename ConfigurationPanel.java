...
public class ConfigurationPanel extends Pane {
                ...
                if (distance < 10) {
                    if (amSelectat == 0 && x != coordDouaBulinaX && y != coordDouaBulinaY) {
                        ...
                        if (amSelectat == 1 && amSelectat2 == 0 && distBetweenSelectedDots > 10 && amSelectat2 == 0 && coordDouaBulinaX != x && coordDouaBulinaY != y && coordPrimaBulinaX != x && coordPrimaBulinaY != y) {
                            ...
                            amSelectat2 = 1;
                            contorPlayer++;
                            System.out.println("intru aici111111111111");
    ...
    public void schimbaCuloarea(Color culoare, double coordPrimaBulinaX, double coordPrimaBulinaY, double coordDouaBulinaX, double coordDouaBulinaY) {
        ...
        {
            contorPlayer--;
            System.out.println("linia nu exista fratelemeleu");
            ...
            {listaDeAdiacenta1.get(tinutMinte1).remove(Integer.valueOf(tinutMinte2));
                ...
                for (int i = 0; i < listaDeAdiacenta1.size(); i++) {
                    System.out.print("Node " + i + " is adjacent to: ");
                    for (int j = 0; j < listaDeAdiacenta1.get(i).size(); j++) {
                        System.out.print(listaDeAdiacenta1.get(i).get(j) + " ");
                    }
                    System.out.println();
                }
            ...
            {   listaDeAdiacenta1.get(tinutMinte1).remove(Integer.valueOf(tinutMinte2));
                ...
                for (int i = 0; i < listaDeAdiacenta2.size(); i++) {
                    System.out.print("Node " + i + " is adjacent to: ");
                    for (int j = 0; j < listaDeAdiacenta2.get(i).size(); j++) {
                        System.out.print(listaDeAdiacenta2.get(i).get(j) + " ");
                    }
                    System.out.println();
                }
    ...
    public void finalMeciEgalitate(){
        System.out.println("Meciu s-a terminat iar rezultatul este egalitate");
        jocTerminat=1;
    }
